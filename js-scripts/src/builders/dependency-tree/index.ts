...
export default function buildDependencyTree() {
  console.log("### Starting to build dependency tree...");
  const rootRepoPath: string | undefined = resolve(
    process.env.REPOSITORY_PATH ?? "DOES NOT EXIST"
  );
  if (rootRepoPath === undefined || !existsSync(rootRepoPath)) {
    console.log("### REPOSITORY NOT FOUND", rootRepoPath);
    return;
  }
